        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="fecha_lanzamiento_libro" type="date" class="form-control" id="fecha_lanzamiento_libro" placeholder="Fecha Lanzamiento Libro">@error('fecha_lanzamiento_libro') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
